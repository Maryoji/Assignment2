...
%%
% 
% * The analytical solution is easier to implement aside from finding the expression for the analytical solution.
% * For Finite Difference, there is more to the implementation because it requires the generation of the G and F matrices.
% * For complex problems, FD will be preferred as it is more flexible than finding the analytical solution. Finding the analytical solution for complex problems will be difficult.
%
